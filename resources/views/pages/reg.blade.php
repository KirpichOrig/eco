    ...
    <div class="montserrat flex">      
        ...
        <div class="w-1/2 h-screen flex flex-col justify-center items-center relative">
            <div class="flex flex-col gap-8">
                <div>
                    <p class="font-[700] text-[50px]">Sign in</p>
                    <p class="mt-[-8px]">Welcome! Already registered? <a class="text-[#72A233]" href="{{ url('/login') }}">Log in</a></p>
                </div>
                ...
                <form action="{{ url('/register') }}" method="POST" class="flex flex-col w-[500px] gap-2">
                    @csrf
                    <input type="text" name="name" placeholder="Name" class="border-b pl-1 pr-1 placeholder:text-black">
                    <input type="text" name="email" placeholder="Email" class="border-b pl-1 pr-1 placeholder:text-black">
                    <input type="password" name="password" placeholder="Password" class="border-b pl-1 pr-1 placeholder:text-black">
                    <input type="password" name="password_confirmation" placeholder="Password confirm" class="border-b pl-1 pr-1 placeholder:text-black">
